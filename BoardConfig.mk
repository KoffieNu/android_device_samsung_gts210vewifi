...
LOCAL_PATH := device/samsung/gts210vewifi
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset BOARD_RAMDISK_OFFSET --tags_offset BOARD_KERNEL_TAGS_OFFSET --board FPRPG21W000KU --dt device/samsung/gts210vewifi/stock/dt.img
